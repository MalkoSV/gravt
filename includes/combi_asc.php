<?php
    ...
    $db_goals = $db->query('SELECT game_id, half, time_point AS goaltime, author_id, assist_id, assist2_id FROM goals WHERE game_id !=2');
    ...
    echo 'Таблица "Наши голы: ЧЕТВЕРКИ игроков (без Аскета)"  готова!';
